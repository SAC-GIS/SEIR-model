...
# 读取头条数据
use_toutiao_date = "2021-12-01"
# https://interface.sina.cn/news/wap/fymap2020_data.d.json---新浪数据接口
...
for city1 in province:
    # 数据里面的cities出现了None，影响后面结果，要去掉这种情况---lry
 if province["cities"]!=None:
...
# 目前接口里面没有了world这个字段，为了避免报错，暂时注释掉---lry
